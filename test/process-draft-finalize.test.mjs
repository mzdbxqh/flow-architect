...
async function createTestRunDir(runDir) {
  ...
  await writeFile(join(runDir, 'stages', 'merge', 'process-draft.json'), JSON.stringify({
    ...
    process_card: {
      ...
      description: '测试流程描述',
      purpose: '测试流程目的',
      owner: 'Role-applicant',
      parent_process_name: null,
      inputs: ['申请单'],
      outputs: ['审批结果'],
      start: {
        event_id: 'Start-request',
        name: '收到申请',
        event_type: 'NONE',
      },
      end_results: [
        {
          event_id: 'End-approved',
          name: '申请已批准',
        },
      ],
    ...
    activities: [
      {
        ...
        name: '提交申请',
        description: '填写并提交业务申请',
        activity_type: 'STANDARD',
        responsibility_model: 'RASCI',
        role_assignments: [
          { role_id: 'Role-applicant', responsibility: 'R' },
          { role_id: 'Role-reviewer', responsibility: 'A' },
        ],
        sla: null,
        tools: [],
        inputs: [],
        process_summary: '填写申请单并提交',
        outputs: ['申请单'],
        completion_criteria: [],
        references: [],
      ...
      },
      {
        ...
        name: '审批申请',
        description: '审查并决定是否批准申请',
        activity_type: 'STANDARD',
        responsibility_model: 'RASCI',
        role_assignments: [
          { role_id: 'Role-reviewer', responsibility: 'R' },
          { role_id: 'Role-applicant', responsibility: 'I' },
        ],
        sla: null,
        tools: [],
        inputs: ['申请单'],
        process_summary: '审核申请内容并做出决定',
        outputs: ['审批结果'],
        completion_criteria: [],
        references: [],
    ...
    diagram: {
      lanes: [
        { lane_id: 'Lane-applicant', name: '申请人', role_id: 'Role-applicant' },
        { lane_id: 'Lane-reviewer', name: '审批人', role_id: 'Role-reviewer' },
      ],
      nodes: [
        { node_id: 'Start-request', node_type: 'START_EVENT', name: '收到申请', lane_id: null },
        { node_id: 'Task-submit', node_type: 'MAIN_TASK', name: '提交申请', lane_id: 'Lane-applicant' },
        { node_id: 'Task-review', node_type: 'MAIN_TASK', name: '审批申请', lane_id: 'Lane-reviewer' },
        { node_id: 'End-approved', node_type: 'END_EVENT', name: '申请已批准', lane_id: null },
      ],
      flows: [
        { flow_id: 'Flow-1', source_ref: 'Start-request', target_ref: 'Task-submit', condition: null },
        { flow_id: 'Flow-2', source_ref: 'Task-submit', target_ref: 'Task-review', condition: null },
        { flow_id: 'Flow-3', source_ref: 'Task-review', target_ref: 'End-approved', condition: null },
      ],
      task_bindings: [
